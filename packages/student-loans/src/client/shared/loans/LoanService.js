import {getAuthState, SIGNED_IN} from '../auth/AuthAccessor'
import {fetchLoans} from './LoanActions'

export default class LoanService {
  static create(store) {
    const eventMachine = new LoanService(store)
    eventMachine.listen()
    return eventMachine
  }
