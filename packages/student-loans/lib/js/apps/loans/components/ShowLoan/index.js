...
import {deleteLoan} from 'js/shared/loans/LoanActions'
import {replaceQuery} from 'js/shared/routing/RoutingActions'
        ...
        <Grid>
          <GridRow colSpacing="none" vAlign="middle">
            ...
            <GridCol width="auto">
              ...
              <Button margin="0 0 0 x-small" onClick={this.handleDelete} size="small" variant="icon">
