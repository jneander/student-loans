...
class CreateLoan extends React.PureComponent {
  constructor (props) {
    super(props);
  ...
  render () {
    return (
      <div className={styles.ContentContainer}>
        <FormFieldGroup layout="columns" description="Loan" vAlign="top" colSpacing="medium" rowSpacing="medium">
...
function mapDispatchToProps (dispatch, ownProps) {
  return {
    onCreate (loan) {
      dispatch(LoanActions.createLoan(loan));
    }
  };
}
